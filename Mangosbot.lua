...
local function toggleIcons()
    if (mangosbot_options.nativeIcons == true) then
        ...
        DEFAULT_CHAT_FRAME:AddMessage(MANGOSBOT_ICONS_DISABLED)
    else
        mangosbot_options.nativeIcons = true
        DEFAULT_CHAT_FRAME:AddMessage(MANGOSBOT_ICONS_ENABLED)
    end
...
function CreateBotRoster()
    ...
    for i = 1,10 do
        ...
        CreateToolBar(item, -18, "quickbar"..i, {
            ...
            ["summon"] = {
                icon = "summon",
                command = {[0] = ""},
                tooltip = L("Summon at meeting stone"),
                strategy = "",
                index = 3
            },
            ["menu"] = {
    ...
    CreateToolBar(frame, 0, "quickbar", {
        ...
        ["summon_all"] = {
            icon = "summon",
            command = {[0] = ""},
            tooltip = L("Summon all bots at meeting stone"),
            strategy = "",
            index = 4
        }
    }, 5, 0, false)
...
function CreateRtiToolBar(frame, y, name, group, x, spacing, register)
    return CreateToolBar(frame, -y, name, {
        ...
        ["rti_triangle"] = {
            ...
            rti = "triangle",
            tooltip = L("Attack triangle mark"),
            index = 5,
            group = group
        },
        ["rti_diamond"] = {
...
function CreateRtiCcToolBar(frame, y, name, group, x, spacing, register)
    return CreateToolBar(frame, -y, name, {
		...
		["rti_none"] = {
            ...
            rti_cc = "none",
            tooltip = L("Ignore rti marks for CC"),
            index = 8,
            group = group
        },
    }, x, spacing, register)
...
function CreateMovementToolBar(frame, y, name, group, x, spacing, register)
    ...
    if (not group) then		
        tb["grind"] = {
            ...
            strategy = "grind",
            tooltip = L("Aggresive mode (grinding)"),
            index = index,
            group = group
        }
        index = index + 1
    ...
    tb["flee_passive"] = {
        ...
        command = {[0] = "#a flee ?"},
        strategy = "passive",
        tooltip = L("Ignore everything and follow master"),
        index = index,
        group = group,
        emote = "flee"
    }
...
function CreateFormationToolBar(frame, y, name, group, x, spacing, register)
    return CreateToolBar(frame, -y, name, {
        ...
        ["arrow"] = {
            ...
            formation = "arrow",
            tooltip = L("Tank first, dps/healer last"),
            index = 2,
            group = group
        },
        ["far"] = {
...
function CreateStanceToolBar(frame, y, name, group, x, spacing, register)
    return CreateToolBar(frame, -y, name, {
        ...
        ["turnback"] = {
            ...
            stance = "turnback",
            tooltip = L("Tank the enemy away from party"),
            index = 2,
            group = group
        },
        ["behind"] = {
            ...
            stance = "behind",
            tooltip = L("Attack from behind (melee)"),
            index = 3,
            group = group
        }
    }, x, spacing, register)
...
function CreateGenericNonCombatToolBar(frame, y, name, group, x, spacing, register)
    return CreateToolBar(frame, -y, name, {
        ...
        ["gather"] = {
            ...
            strategy = "gather",
            tooltip = L("Gather herbs, ore, etc."),
            index = 2,
            group = group
        },
        ["reveal"] = {
            ...
            strategy = "reveal",
            tooltip = L("Reveal gathering nodes"),
            index = 3
        },
        ["mount"] = {
            icon = "mount",
            ...
            strategy = "mount",
            tooltip = L("Mount up when possible"),
            index = 4
        },		
        ["travel"] = {
            icon = "travel",
            ...
            strategy = "travel",
            tooltip = L("Move to distant locations"),
            index = 5
        }
    }, x, spacing, register)
end
...
function CreateGenericCombatToolBar(frame, y, name, group, x, spacing, register)
    return CreateToolBar(frame, -y, name, {
        ...
        ["cast_time"] = {
            ...
            strategy = "cast time",
            tooltip = L("Do not cast long spells on almost dead targets"),
            index = 1,
            group = group
        },
        ["mark_rti"] = {
            ...
            strategy = "mark rti",
            tooltip = L("Mark current target with raid icon"),
            index = 2,
            group = group
        },
        ["ads"] = {
            ...
            strategy = "ads",
            tooltip = L("Flee if ads might be pulled"),
            index = 3,
            group = group
        },
        ["conserve_mana"] = {
            ...
            tooltip = L("Reduce mana usage at cost of DPS"),
            index = 4,
            group = group
        },
        ["cc"] = {
            ...
            command = {[0] = "#a co ~cc,?"},
            strategy = "cc",
            tooltip = L("Use crowd control abilities"),
            index = 5,
            group = group
        }
    }, x, spacing, register)
...
function CreateSaveManaToolBar(frame, y, name, group, x, spacing, register)
    ...
    for i = 1, 5 do
        buttons["savemana"..i] = {
            ...
            tooltip = L("Save mana level: ")..(i>1 and "#"..i or "disabled"),
            index = i - 1,
            group = group,
            savemana = i
        }
...
function CreateSelectedBotPanel()
    ...
    CreateToolBar(frame, -y, "actions", {
        ["stats"] = {
            ...
            command = {[0] = "stats"},
            strategy = "",
            tooltip = L("Tell stats (XP, bag space, money, durability)"),
            index = 0
        },
        ["whisper"] = {
            icon = "whisper",
        ...
        ["talk"] = {
            ...
            strategy = "",
            tooltip = L("Talk to nearby NPCs to complete or accept quests"),
            index = 3
        },
        ["set_guard"] = {
            icon = "set_guard",
        ...
        ["revive"] = {
            ...
            strategy = "",
            tooltip = L("Revive at Spirit Healer"),
            index = 6
        },
        ["sell"] = {
            icon = "sell",
    ...
    CreateToolBar(frame, -y, "inventory", {
        ["los"] = {
            ...
            command = {[0] = "los gos"},
            strategy = "",
            tooltip = L("Show nearby game objects"),
            index = 0
        },
        ["count"] = {
            icon = "count",
    ...
    CreateToolBar(frame, -y, "rpg", {
        ["rpg"] = {
            ...
            command = {[0] = "#a nc ~rpg,?"},
            strategy = "rpg",
            tooltip = L("Rpg with nearby npcs"),
            index = 0
        },
        ["rpg quest"] = {
            icon = "rpg_quest",
        ...
        ["rpg explore"] = {
            ...
            tooltip = L("Talk to inns, flightmasters"),
            index = 3
        },
        ["rpg maintenance"] = {
            ...
            tooltip = L("Talk to armorers, trainers"),
            index = 4
        },
        ["rpg player"] = {
            icon = "rpg_player",
        ...
        ["rpg craft"] = {
            ...
            strategy = "rpg craft",
            tooltip = L("Craft items, casts spells"),
            index = 6
        },
        ["rpg bg"] = {
            icon = "rpg_bg",
            ...
            strategy = "rpg bg",
            tooltip = L("Queue for bg at battlemasters"),
            index = 7
        }			
    })	
    ...
    CreateToolBar(frame, -y, "loot", {
        ["ll_equip"] = {
            ...
            command = {[0] = "ll ~equip"},
            loot = "equip",
            tooltip = L("Loot equipment upgrades"),
            index = 0
        },
        ["ll_qyest"] = {
            icon = "ll_quest",
        ...
        ["ll_skill"] = {
            ...
            command = {[0] = "ll ~skill"},
            loot = "skill",
            tooltip = L("Loot tradeskill items"),
            index = 2
        },		
        ["ll_disenchant"] = {
            icon = "ll_disenchant",
            ...
            loot = "disenchant",
            tooltip = L("Loot items for disenchanting"),
            index = 3
        },
        ["ll_use"] = {
            icon = "ll_use",
            command = {[0] = "ll ~use"},
            loot = "use",
            tooltip = L("Loot consumables/reagents"),
            index = 4
        },
        ["ll_vendor"] = {
            icon = "ll_vendor",
            command = {[0] = "ll ~vendor"},
            loot = "vendor",
            tooltip = L("Loot items for money"),
            index = 5
        },		
        ["ll_trash"] = {
            icon = "ll_trash",
    ...
    CreateToolBar(frame, -y, "attack_type", {
        ["tank_aoe"] = {
            ...
            tooltip = L("Grab all aggro or attack Raid Mark"),
            index = 0
        },
        ["dps_assist"] = {
            icon = "dps_assist",
            ...
            strategy = "dps assist",
            tooltip = L("Attack least hp target or Raid Mark"),
            index = 1
        },
        ["close"] = {
            icon = "close",
		...
		["wait_for_attack"] = {
            ...
            tooltip = L("Wait X seconds before attacking. To change the amount of seconds use 'wait for attack time X'"),
            index = 5
        },
		["pull"] = {
            icon = "pull",
            command = {[0] = "#a co ~pull,?"},
            strategy = "pull",
            tooltip = L("Set this bot to pull using the 'pull command'. Recommended to only have one bot with pull enabled."),
            index = 6
        },
		["pull back"] = {
            icon = "pull_back",
            ...
            strategy = "pull back",
            tooltip = L("Pull back monsters back to the location where the 'pull command' was given."),
            index = 7
        }
    })
    ...
    CreateToolBar(frame, -y, "CLASS_DRUID", {
        ...
        ["heal"] = {
            ...
            tooltip = L("Restoration mode (healer)"),
            index = 3
        },
		["aoe"] = {
            icon = "caster_aoe",
		...
		["boost"] = {
            ...
            strategy = "boost",
            tooltip = L("Use boost abilities (cooldowns, trinkets)"),
            index = 6
        },
        ["cure"] = {
            icon = "cure",
            ...
            strategy = "cure",
            tooltip = L("Use cure abilities (poisons and curses)"),
            index = 7
        },
		["offheal"] = {
            icon = "heal",
            ...
            strategy = "offheal",
            tooltip = L("Use healing abilities to heal other party members while being in dps mode"),
            index = 8
        },
		["stealth"] = {
            icon = "caster",
            ...
            strategy = "stealth",
            tooltip = L("Use stealth abilities"),
            index = 9
        },
		["preheal"] = {
            icon = "heal",
            ...
            strategy = "preheal",
            tooltip = L("Heal the party before receiving melee damage"),
            index = 10
        }
    })
    CreateToolBar(frame, -y, "CLASS_HUNTER", {
	    ["bm"] = {
            ...
            tooltip = L("Beast mastery mode (dps)"),
            index = 0
        },
        ["ms"] = {
            icon = "dps",
            ...
            tooltip = L("Marksmanship mode (dps)"),
            index = 1
        },
        ["caster"] = {
            icon = "caster",
    ...
    CreateToolBar(frame, -y, "CLASS_MAGE", {
        ...
        ["bdps"] = {
            ...
            command = {[0] = "#a co ~buff,?", [1] = "#a nc ~buff,?"},
            strategy = "buff",
            tooltip = L("Use buff abilities (cooldowns, trinkets, buffs)"),
            index = 4
        },
		["boost"] = {
            icon = "boost",
        ...
        ["cure"] = {
            ...
            command = {[0] = "#a co ~cure,?", [1] = "#a nc ~cure,?"},
            strategy = "cure",
            tooltip = L("Use cure abilities (curses)"),
            index = 6
        }
    })
    CreateToolBar(frame, -y, "CLASS_PALADIN", {
        ["retribution"] = {
            ...
            tooltip = L("Retribution mode (melee)"),
            index = 0
        },
        ["protection"] = {
            icon = "tank",
            ...
            strategy = "protection",
            tooltip = L("Protection mode (tank)"),
            index = 1
        },
        ["holy"] = {
            icon = "heal",
    ...
    CreateToolBar(frame, -y, "CLASS_PRIEST", {
        ["discipline"] = {
            ...
            strategy = "discipline",
            tooltip = L("Discipline mode (healer)"),
            index = 0
        },
        ["holy"] = {
            icon = "holy",
		...
		["offdps"] = {
            ...
            strategy = "offdps",
            tooltip = L("Use dps abilities to attack enemies while being on healer mode"),
            index = 8
        },
		["preheal"] = {
            icon = "heal",
    ...
    CreateToolBar(frame, -y, "CLASS_ROGUE", {
		...
		["assassination"] = {
            ...
            tooltip = L("Assassination mode (melee)"),
            index = 1
        },
		["subtlety"] = {
            icon = "dps",
    ...
    CreateToolBar(frame, -y, "CLASS_SHAMAN", {
        ["caster"] = {
            ...
            strategy = "elemental",
            tooltip = L("Elemental mode (caster)"),
            index = 0
        },
        ["heal"] = {
            icon = "heal",
        ...
        ["melee"] = {
            ...
            tooltip = L("Enhancement mode (melee)"),
            index = 2
        },
        ["aoe"] = {
            icon = "caster_aoe",
        ...
        ["cure"] = {
            ...
            command = {[0] = "#a co ~cure,?", [1] = "#a nc ~cure,?"},
            strategy = "cure",
            tooltip = L("Use cure abilities (poison and disease)"),
            index = 6
        },
		["offheal"] = {
            icon = "heal",
    ...
    CreateToolBar(frame, -y, "CLASS_WARLOCK", {
        ["affliction"] = {
            ...
            strategy = "affliction",
            tooltip = L("Affliction mode (caster)"),
            index = 0
        },
        ["demonology"] = {
            icon = "dps",
            ...
            strategy = "demonology",
            tooltip = L("Demonology mode (caster)"),
            index = 1
        },
		["destruction"] = {
            icon = "dps",
            ...
            tooltip = L("Destruction mode (caster)"),
            index = 2
        },
		["aoe"] = {
            icon = "aoe",
    ...
    CreateToolBar(frame, -y, "CLASS_PALADIN_BLESSING", {
        ...
        ["barmor"] = {
            ...
            tooltip = L("Blessing of Sanctuary"),
            index = 3
        },
        ["blight"] = {
            icon = "bmana",
        ...
        ["bstats"] = {
            ...
            tooltip = L("Blessing of salvation"),
            index = 5
        }
    })
	CreateToolBar(frame, -y, "CLASS_SHAMAN_TOTEM_EARTH", {
		["stoneclaw"] = {
            ...
            tooltip = L("Stoneclaw totem (earth)"),
            index = 0
        },
		["stoneskin"] = {
            icon = "totems",
            ...
            tooltip = L("Stoneskin totem (earth)"),
            index = 1
        },
		["earthbind"] = {
            icon = "totems",
            ...
            tooltip = L("Earthbind totem (earth)"),
            index = 2
        },
		["strength"] = {
            icon = "totems",
            ...
            tooltip = L("Strength of Earth totem (earth)"),
            index = 3
        },
		["tremor"] = {
            icon = "totems",
	...
	CreateToolBar(frame, -y, "CLASS_ROGUE_POISON_MAIN", {
		["deadly"] = {
            ...
            tooltip = L("Deadly Poison (main hand)"),
            index = 0
        },
		["crippling"] = {
            icon = "caster_aoe",
            ...
            tooltip = L("Crippling Poison (main hand)"),
            index = 1
        },
		["mind"] = {
            icon = "caster_aoe",
            ...
            tooltip = L("Mind-Numbing Poison (main hand)"),
            index = 2
        },
		["instant"] = {
            icon = "caster_aoe",
            ...
            tooltip = L("Instant Poison (main hand)"),
            index = 3
        },
		["wound"] = {
            icon = "caster_aoe",
            ...
            tooltip = L("Wound Poison (main hand)"),
            index = 4
        },
		["anesthetic"] = {
            icon = "caster_aoe",
            ...
            tooltip = L("Anesthetic Poison (main hand)"),
            index = 5
        }
	})
	CreateToolBar(frame, -y, "CLASS_WARLOCK_CURSES", {
		...
		["elements"] = {
            ...
            tooltip = L("Curse of the Elements"),
            index = 2
        },
		["recklessness"] = {
            icon = "caster_aoe",
            ...
            tooltip = L("Curse of Recklessness"),
            index = 3
        },
		["weakness"] = {
            icon = "caster_aoe",
    ...
    CreateToolBar(frame, -y, "CLASS_PALADIN_AURA", {
        ...
        ["rshadow"] = {
            ...
            tooltip = L("Shadow resistance aura"),
            index = 3
        },
        ["rfrost"] = {
            icon = "frost",
            ...
            strategy = "aura frost",
            tooltip = L("Frost resistance aura"),
            index = 4
        },
        ["rfire"] = {
            icon = "fire",
            ...
            strategy = "aura fire",
            tooltip = L("Fire resistance aura"),
            index = 5
        },
        ["crusader"] = {
            icon = "bspeed",
	...
	CreateToolBar(frame, -y, "CLASS_SHAMAN_TOTEM_FIRE", {
		["nova"] = {
            ...
            tooltip = L("Fire Nova totem (fire)"),
            index = 0
        },
		["flametongue"] = {
            icon = "totems",
            ...
            tooltip = L("Flametongue totem (fire)"),
            index = 1
        },
		["resistance"] = {
            icon = "totems",
            ...
            tooltip = L("Frost Resistance totem (fire)"),
            index = 2
        },
		["magma"] = {
            icon = "totems",
	...
	CreateToolBar(frame, -y, "CLASS_ROGUE_POISON_OFF", {
		["deadly"] = {
            ...
            tooltip = L("Deadly Poison (off hand)"),
            index = 0
        },
		["crippling"] = {
            icon = "caster_aoe",
            ...
            tooltip = L("Crippling Poison (off hand)"),
            index = 1
        },
		["mind"] = {
            icon = "caster_aoe",
            ...
            tooltip = L("Mind-Numbing Poison (off hand)"),
            index = 2
        },
		["instant"] = {
            icon = "caster_aoe",
            ...
            tooltip = L("Instant Poison (off hand)"),
            index = 3
        },
		["wound"] = {
            icon = "caster_aoe",
            ...
            tooltip = L("Wound Poison (off hand)"),
            index = 4
        },
		["anesthetic"] = {
            icon = "caster_aoe",
            ...
            tooltip = L("Anesthetic Poison (off hand)"),
            index = 5
        }
	})
	CreateToolBar(frame, -y, "CLASS_WARLOCK_PETS", {
		...
		["monkey"] = {
            ...
            tooltip = L("Aspect of the Monkey"),
            index = 1
        },
		["cheetah"] = {
            icon = "totems",
            ...
            tooltip = L("Aspect of the Cheetah"),
            index = 2
        },
		["pack"] = {
            icon = "totems",
		...
		["dragonhawk"] = {
            ...
            tooltip = L("Aspect of the Dragonhawk"),
            index = 7
        }
	})
	...
	CreateToolBar(frame, -y, "CLASS_SHAMAN_TOTEM_WATER", {
		["cleansing"] = {
            ...
            tooltip = L("Cleansing totem (water)"),
            index = 0
        },
		["resistance"] = {
            icon = "totems",
            ...
            tooltip = L("Fire Resistance totem (water)"),
            index = 1
        },
		["healing"] = {
            icon = "totems",
            ...
            tooltip = L("Healing Stream totem (water)"),
            index = 2
        },
		["mana"] = {
            icon = "totems",
            ...
            tooltip = L("Mana Spring totem (water)"),
            index = 3
        },
		["poison"] = {
            icon = "totems",
            ...
            tooltip = L("Poison Cleansing totem (water)"),
            index = 4
        }
	})
	...
	CreateToolBar(frame, -y, "CLASS_SHAMAN_TOTEM_AIR", {
		["grace"] = {
            ...
            tooltip = L("Grace of Air totem (air)"),
            index = 0
        },
		["grounding"] = {
            icon = "totems",
		...
		["resistance"] = {
            ...
            tooltip = L("Nature Resistance totem (air)"),
            index = 2
        },
		["tranquil"] = {
            icon = "totems",
            ...
            tooltip = L("Tranquil Air totem (air)"),
            index = 3
        },
		["windfury"] = {
            icon = "totems",
		...
		["wrath"] = {
            ...
            tooltip = L("Wrath of Air totem (air)"),
            index = 6
        }
	})
